...
(function courseToggle() {
    ...
    function unActiveBtnContainer (active, unActive) {
        active.classList.add('btn-study-route-active');
        unActive.classList.remove('btn-study-route-active');
    }
    
    btnFrontEndOfContainer.addEventListener('click', 
                                        unActiveBtnContainer(
                                        btnFrontEndOfContainer, btnBackEndOfContainer));
    btnBackEndOfContainer.addEventListener('click', 
                                        unActiveBtnContainer(
                                        btnBackEndOfContainer, btnFrontEndOfContainer));
